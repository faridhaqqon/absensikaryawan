                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <form action="/departemen/{{ $d->kode_dept }}/delete" method="POST"
                                                                ...
                                                                <a class="btn btn-danger btn-sm delete-confirm">
                                                                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-eraser">
                                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nip" class="form-control" placeholder="Kode Divisi" name="kode_dept">
                                  </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nama_dept" class="form-control" placeholder="Nama Divisi" name="nama_dept">
                                  </div>
                            </div>
                        </div>
    ...
    $(function(){
        ...
        $(".delete-confirm").click(function(e){
           var form = $(this).closest('form');
            e.preventDefault()
            Swal.fire({
                title: "Apakah Anda Yakin Ingin Data Ini Dihapus?",

    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $departemen->kode_dept }}" id="nip" class="form-control" placeholder="Kode Divisi" name="kode_dept" readonly>
              </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $departemen->nama_dept }}" id="nama_dept" class="form-control" placeholder="Nama Divisi" name="nama_dept">
              </div>
        </div>
    </div>

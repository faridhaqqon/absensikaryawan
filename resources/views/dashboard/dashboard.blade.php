                ...
                <div class="card-body">
                    <div class="historicontent">
                        <div class="iconpresensi">
                            <ion-icon name="hand-right-outline" style="font-size: 40px;" class="text-success"></ion-icon>
                        </div>
                            <div class="datapresensi">
                                ...
                                <span>
                                    {!! $d->jam_in != null ? date("H:i",strtotime($d->jam_in)) : '<span class="text-danger">Absen Pulang</span>' !!}
                                </span>
                                <span>
                                    {!! $d->jam_out != null ? "-". date("H:i",strtotime($d->jam_out)) : '<span class="text-danger"> - Absen Pulang</span>' !!}
                                </span>                              
                        </div>
                    </div>
                </div>
                    ...
                    <li>
                        <div class="item">
                            ...
                            <div>
                                ...
                                <span class="badge {{ $d->jam_in < "08:31" ? "bg-success" : "bg-danger" }}">
                                    {{ $d->jam_in }}
                                </span>
                            </div>
                        </div>

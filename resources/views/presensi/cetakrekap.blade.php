...
<body class="A4 landscape">
  ...
  <section class="sheet padding-10mm">
    ...
    <table class="tabelpresensi">
        ...
        <tr>
           <td>{{ $d->nip }}</td>
            ...
            <td>
                <span style="color:{{ $hadir[0]>"08:31:00" ? "red" : "" }}">{{ $hadir[0] }}</span><br>
                <span style="color:{{ $hadir[1]<"17:31:00" ? "black" : "" }}">{{ !empty($hadir[1]) ? $hadir[1] : '-'}}</span>
            </td>
            <?php
            }
            ?>
    ...
    <table width="100%" style="margin-top:20px">
        <tr>
            <td style="text-align:left">Bekasi, {{ date('d M Y') }}</td>
        </tr>
        <tr>

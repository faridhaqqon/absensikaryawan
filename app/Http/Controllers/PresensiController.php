...
class PresensiController extends Controller
{
    ...
    public function store(Request  $request)
    {
        ...
        if($cek > 0){
            ...
            if ($update) {
                ...
                echo "error|Gagal Absen, Coba Lagi Atau Hubungi IT|out";
            }
        } else {
            $data = [
                'nip' => $nip ,
            ...
            if ($simpan) {
                ...
                echo "error|Gagal Absen, Coba Lagi Atau Hubungi IT|in";
            }
         }
    }
}
    ...
    public function cetaklaporan(Request $request)
    {
        ...
        if (isset($_POST['exportexcel'])) {
            ...
            // Fungsi header dengan mengirimkan raw data exccel
             header("Content-type: application/vnd-ms-excel");
            // Mendefinisikan nama file ekspor "hasil-export.xls"
            header("Content-Disposition: attachment; filename=Laporan Presensi Karyawan PT. Sinar Mulia Sejahtera $time.xls");
    ...
    public function cetakrekap(Request $request)
    {
        ...
        if (isset($_POST['exportexcel'])) {
            ...
            // Fungsi header dengan mengirimkan raw data exccel
             header("Content-type: application/vnd-ms-excel");
            // Mendefinisikan nama file ekspor "hasil-export.xls"
            header("Content-Disposition: attachment; filename=Rekap Presensi Karyawan PT. Sinar Mulia Sejahtera $time.xls");
        }
